...
<head>
    ...
    <link rel="stylesheet" href="src/frontend/css/root.css">
...
<body>
    ...
    <?php
        include("src/includes/navbar.html")
    ?>
    ...
    <section class="apresentacao">
        ...
        <img class="welcome-photo" src="src/utils/img/Arcano.webp">
    </section>
    ...
    <section class="noticias">
        ...
        <article class="article-principal">
            <div class="img-container">
                <img src="src/utils/img/oldFaker.png">
            </div>
        ...
        <article class="primeira-article sub-article">
            ...
            <img src="src\utils\img\Ferias_com_Axt.jpeg">
        </article>
        ...
        <article class="segunda-article sub-article">
            ...
            <img src="src\utils\img\legendsOFruneterra.jpg">
        </article>
        ...
        <article class="terceira-article sub-article">
            ...
            <img src="src\utils\img\LLL Kyuzans.webp">
        </article>
    ...
    <section class="nossos-jogos">
        ...
        <div class="container-jogos">
            ...
            <article class="LOL">
                <img class="card" src="src\utils\img\LOL.png">
            </article>

            <article class="valoroso">
                <img class="card" src="src\utils\img\Valoroso.png">
            </article>

            <article class="TFT">
                <img class="card" src="src\utils\img\TFT.png">
            </article>
        </div>
    ...
    <section class="trabalhe-conosco">
        ...
        <img src="src\utils\img\Comunidade.jpg">
    </section>
